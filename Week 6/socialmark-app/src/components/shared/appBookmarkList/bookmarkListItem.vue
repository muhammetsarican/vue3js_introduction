            ...
            <div class="flex items-center justify-center mt-2 gap-x-1">
                ...
                <div class="relative group">
                    <button class="details-btn !-z-[1] group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current group-hover:text-gray-700" height="24"
                            viewBox="0 0 24 24" width="24">
                        ...
                        <p class="details-container">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                            Similique nemo consequatur a accusamus assumenda laborum consequuntur explicabo dolor,
                            odit eligendi voluptate illum itaque accusantium, cumque tenetur cupiditate illo libero
                            dolores!</p>
                    </button>
                </div>
            </div>
