<template>
    <aside class="flex flex-shrink-0 flex-col h-[100vh] bg-white w-60 border-gray-200 border-r-[1px]">
        <a class="sidebar-item" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current mr-2" height="24" viewBox="0 0 24 24"
                width="24">
        ...
        <a class="sidebar-item" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" class="fill-current mr-2" viewBox="0 0 24 24"
                width="24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
