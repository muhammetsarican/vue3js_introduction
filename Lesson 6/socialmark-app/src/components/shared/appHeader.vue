    ...
    <div class="header-container">
        <nav class="flex w-full px-2">
            <div class="flex text-xl">
                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current mr-2" height="36" viewBox="0 0 24 24"
                    width="36">
            ...
            <div v-if="_isAuthenticated" class="ml-auto flex items-center">
                <router-link :to="{ name: 'NewBookmarkPage' }"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-current" height="16" viewBox="0 0 24 24"
                        width="16">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <div class="relative group">
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" class="fill-current"
                            width="24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                    ...
                    <nav
                        ...
                        <router-link :to="{name:'SettingsPage'}" class="mb-2 menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" class="fill-current mr-1"
                        ...
                        <router-link :to="{ name: 'FavoritesPage' }" class="mb-2 menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current mr-1" height="24"
                                viewBox="0 0 24 24" width="24">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                                <path
                        ...
                        <router-link :to="{ name: 'LikesPage' }" class="mb-2 menu-item">
